package vip.sujianfeng.enjoyapi.rbac.user
...
import vip.sujianfeng.enjoyapi.rbac.user.params.ChangeThemeParam
import vip.sujianfeng.enjoyapi.rbac.user.params.UserPageParam
import vip.sujianfeng.enjoyapi.rbac.user.params.UserPasswordParam
...
class UserApiController: MasterController<RbacUserVO, UserPageParam>() {
    ...
    fun changeTheme(@RequestBody param: ChangeThemeParam): CallResult<String> {
        return CallResult.opCall {
            ...
            val userInfo = vip.sujianfeng.enjoyapi.utils.UserUtils.getCurrUser()
            userInfo.theme = param.theme
            jdbcTbDao().update(userInfo, "theme")
            vip.sujianfeng.enjoyapi.utils.UserUtils.userPutToRedis(vip.sujianfeng.enjoyapi.utils.UserUtils.getToken(), userInfo)
        }
    }
    ...
    fun changeSystem(@RequestBody param: OneIdParam): CallResult<String> {
        return CallResult.opCall {
            ...
            vip.sujianfeng.enjoyapi.utils.UserUtils.userPutToRedis(vip.sujianfeng.enjoyapi.utils.UserUtils.getToken(), rbacUserVO)
        }
    }
